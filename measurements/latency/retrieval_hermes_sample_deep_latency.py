...
def main():
    ...
    output_file = os.path.join(args.output_dir, "hermes_sample_deep_latency.csv")
    ...
    with open(output_file, mode='w', newline='') as file:
        fieldnames = ["Number of Searched Indices", "Sample nProbe", "Deep nProbe", "Retrieved Docs", "Num Threads", "Avg Sample Search Time (s)", "Avg Deep Search Time (s)", "Avg Aggregation Time (s)"]
