...
def main():
    ...
    parser.add_argument(
        ...
        default="data/indices/hermes_clusters/kmeans_centroids.npy",
        help="Path to save KMeans centroids (default: data/indices/hermes_clusters/kmeans_centroids.npy)"
    )
    parser.add_argument(
        "--cluster-indices-dir", type=str,
        default="data/indices/hermes_clusters/cluster_indices",
        help="Directory to save cluster indices (default: data/indices/hermes_clusters/cluster_indices)"
    )
    parser.add_argument(
        "--clusters-output-dir", type=str,
        default="data/indices/hermes_clusters/clusters",
        help="Directory to save FAISS indices for clusters (default: data/indices/hermes_clusters/clusters)"
    )
    parser.add_argument(
