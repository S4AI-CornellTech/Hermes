...
def main():
    ...
    labels = ["Baseline", "Piperag", "Ragcache", "Hermes", "Hermes/PipeRAG/RAGCache"]

    print("Baseline Latency:", baseline_latency)
    print("Piperag Latency:", piperag)
    print("Ragcache Latency:", ragcache)
    print("Hermes Latency:", hermes)
    print("Hermes with Enhancements Latency:", hermes_w_enhancements)
